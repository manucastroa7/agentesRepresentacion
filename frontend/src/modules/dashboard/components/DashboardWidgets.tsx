...
// --- Types ---
export type WidgetType = 'KPI_SQUAD' | 'KPI_SCOUTING' | 'KPI_AGE' | 'KPI_QUALITY' | 'CHART_POSITIONS' | 'LIST_ALERTS' | 'LIST_RECENT';
...
export const WIDGETS_REGISTRY: Record<WidgetType, { component: React.FC<any>, label: string, defaultW: number, defaultH: number }> = {
    KPI_SQUAD: {
...
export const renderWidget = (type: WidgetType, data: any) => {
